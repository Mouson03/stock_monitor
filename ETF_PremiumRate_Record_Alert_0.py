...
# 文件路径
csv_path = os.getenv("CSV_PATH", "etf_premium_rates.csv")
...
def send_dingtalk_message(message):
    webhook_url = "https://oapi.dingtalk.com/robot/send?access_token=f9a9044d1c878dfe372dcef76202"
...
print(f"{today}的ETF溢价率已记录，持有ETF溢价率阈值已检查。")
