...
#2025.10.22   这个代码的溢价率提醒功能可用，但是只能判断大于或小于阈值，修改判断代码的符号就行，不能同时判断。2025.10.27停用该监控程序，改用Premium_Trade_Warn.py
...
# ETF列表，替换为你的基金代码列表
etf_list = ['159941','513100','159632','159513','513300','159501','513390','159696','513110','159659','159660','513870','159509','513500','513650','159612','159655','513850','159577','159529']
...
for etf in etf_list:
    ...
    if not etf_data.empty:
        ...
        # 检查持有的ETF的溢价率是否超过阈值
        if etf in holdings and result_dict[f"{etf}"] < holdings[etf]:            #小于阈值
            alert_message = f"提醒: ETF {etf} 的溢价率为 {result_dict[f'{etf}']}%，小于设定的阈值 {holdings[etf]}%"
