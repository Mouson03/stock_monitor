...
holdings = {
    ...
    '159941': {'lower': 1.0, 'upper': 999},
    '513100': {'lower': 1.0, 'upper': 999},
    '513300': {'lower': 1.0, 'upper': 999},
    '159632': {'lower': 1.0, 'upper': 999},
    '159501': {'lower': 1.0, 'upper': 999},
    '159659': {'lower': 1.0, 'upper': 999},
    '159513': {'lower': 1.0, 'upper': 999},
    '513110': {'lower': 1.0, 'upper': 999},
    '159696': {'lower': 1.0, 'upper': 999},
    '159660': {'lower': 1.0, 'upper': 999},
    '513390': {'lower': 1.0, 'upper': 999},
    '513870': {'lower': 1.0, 'upper': 999},
    '161130': {'lower':-999, 'upper': 5.0},  #纳斯达克100LOF      #20251202已全仓买入此基金，因此需要监控这个基金的右边值。

    # 美国50ETF（规模降序）
    '513850': {'lower': 1.0, 'upper': 999},
    '159577': {'lower': 1.0, 'upper': 999},
