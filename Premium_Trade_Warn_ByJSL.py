#20260304重启溢价套利，这时发现了场外大额申购的方法，也就是各基金app中的纳指和标普限额几千。
...
holdings = {
    ...
    '159941': {'lower': 0.1, 'upper': 999},
    '513100': {'lower': 0.1, 'upper': 999},
    '513300': {'lower': 0.1, 'upper': 999},
    '159632': {'lower': 0.1, 'upper': 999},
    '159501': {'lower': 0.1, 'upper': 999},
    '159659': {'lower': 0.1, 'upper': 999},
    '159513': {'lower': 0.1, 'upper': 999},
    '513110': {'lower': 0.1, 'upper': 999},
    '159696': {'lower': 0.1, 'upper': 999},
    '159660': {'lower': 0.1, 'upper': 999},
    '513390': {'lower': 0.1, 'upper': 999},
    '513870': {'lower': 0.1, 'upper': 999},
    '161130': {'lower':-2.0, 'upper': 999},  #纳斯达克100LOF

    # 美国50ETF（规模降序）
    '513850': {'lower': 0.1, 'upper': 999},
    '159577': {'lower': 0.1, 'upper': 999},
